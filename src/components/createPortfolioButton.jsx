  ...
  return (
    <>
      ...
      <Button
        ...
        sx={{
          backgroundColor: "#2ECC71", // Lighter green color
          color: "#FFFFFF",
          borderRadius: 28,
          transition: "transform 120ms ease, background-color 0.2s ease",
          transform: "translateZ(0)",
          "&:hover": {
            backgroundColor: "#27AE60", // Slightly darker on hover
            transform: "translateY(-1px)"
          },
          "&:active": {
            backgroundColor: "#219653", // Even darker when clicked
        ...
        <form onSubmit={handleSubmit}>
          ...
          <DialogActions sx={{ px: 3, py: 2, bgcolor: "#f7f7f7", borderTop: "1px solid rgba(0,0,0,0.08)" }}>
            ...
            <Button
              ...
              variant="contained"
              disabled={loading}
              startIcon={!loading && <CreateNewFolderIcon />}
              sx={{
                backgroundColor: "#2ECC71", // Lighter green color
                color: "#FFFFFF",
                borderRadius: 28,
